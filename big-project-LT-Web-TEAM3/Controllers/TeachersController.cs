    ...
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Teacher != null ? 
                          ...
                          Problem("Entity set 'Context.Teacher'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TenGV,ChucVuGV")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TenGV,ChucVuGV")] Teacher teacher)
        {
            if (id != teacher.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Context.Teacher'  is null.");
            }
            var teacher = await _context.Teacher.FindAsync(id);
            if (teacher != null)
            {
